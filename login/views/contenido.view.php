...
<html lang="en">
  ...
  <body class="align">
    ...
    <div class="grid">
      ...
      <p class="text--center">Aun no eres usuario? <a href="registro.php">Registrate ahora</a> <svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="assets/images/icons.svg#arrow-right"></use></svg></p>
